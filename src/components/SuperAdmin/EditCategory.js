...
const  EditCategory = () => {
    ...
    useEffect(()=>{
        ...
        axios.get(`http://localhost:5050/superAdmin/getCategorieById/${id}`)
          .then(function (response) {
              
            setImageCategorie(response.data.imageCategorie)
            setNameCategorie(response.data.nameCategorie)
...
//---------add admin------------- 
	...
	axios.put(`http://localhost:5050/superAdmin/updateCategorie/${id}`,Category)
