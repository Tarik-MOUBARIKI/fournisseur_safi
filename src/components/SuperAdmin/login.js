...
const  Login = () => {
	...
	axios.post(`http://localhost:5050/superAdmin/login`, superAdmin)
		.then(res => {
			console.log(res)
    ...
    <div className="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
      <div className="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style={{height: '500px'}}>
        ...
        <div className="hidden md:block md:w-1/2 rounded-r-lg" style={{background: 'url("https://viuz.com/wp-content/uploads/shutterstock_1276617907-1024x683.jpg")', backgroundSize: 'cover', backgroundPosition: 'center center',height:500,width:530}} />
      </div>
    </div>
  </div>
    )
