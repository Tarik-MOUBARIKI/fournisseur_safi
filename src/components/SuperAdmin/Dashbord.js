...
useEffect(()=>{
  ...
  axios.get(`http://localhost:5050/superAdmin/getAllFournisseur`)
    .then(function (response) {
        
      setFournisseurs(response.data.length)
    ...
    <div className="flex flex-wrap -m-4 text-center">
      ...
      {/* <div className="p-4 md:w-2/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed">Demande Fournisseurs</p>
        </div>
      </div> */}
      <div className="p-4 md:w-4/4 sm:w-2/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
            <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" />
            <circle cx={9} cy={7} r={4} />
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">{fournisseurs}</h2>
          <p className="leading-relaxed">All Fournisseurs</p>
        </div>
      </div>
