...
//---------add admin------------- 
    ...
    const Fournisseur = {fullName,company,email,login,password};

	axios.post(`http://localhost:5050/superAdmin/addFournisseur`,Fournisseur)
    ...
    <div className="relative sm:max-w-sm w-full">
      ...
      <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
        ...
        <form method="#" action="#" className="mt-10" onSubmit={handleSubmit}>
          ...
          <div className="mt-7">
            <input type="text" placeholder="Company" className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"  required 
            value={company}
